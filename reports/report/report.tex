...
In order to confirm our intuitions about influential network chracateristics, 
...
differences in Section~\ref{sec:model} and during evaluation in Section~\ref{eval}.

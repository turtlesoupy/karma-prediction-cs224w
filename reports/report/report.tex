...
\begin{figure*}[t]
\centering
\includegraphics[width=\linewidth]{powerlaws}
...
\hline
Baseline & 0.63  & 563.17 & 0.55 & 0.77 & 187.35 & 0.96 \\
Weighted PageRank & 0.72  & 485.44 & 0.67 & 0.75 & 185.26  & 0.97 \\
HITS & 0.71 & 505.69 & 0.638 & 0.76 & 185.47 & 0.97 \\
Constraint & 0.72 & 562.63 & 0.55 & 0.73 & 187.17 & 0.96 \\
Textual & 0.70 & 561.79 & 0.55 & 0.74 & 187.32 & 0.96 \\
All Features & \textbf{0.77} & \textbf{469.9} (RF) & \textbf{0.69} (RF) &
\textbf{0.82} & \textbf{185.04} & \textbf{0.97} \\
\hline
\end{tabular}
